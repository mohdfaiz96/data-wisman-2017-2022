...
# Menambahkan Foto
st.image('Tanah Lot.jpg', caption="Tanah Lot yang terletak di Bali menjadi salah satu destinasi wisata favorit wisatawan mancanegara di Indonesia. (Sumber: Pexels.com/Yousef Salah)")
...
def main():
    ...
    with st.expander("Tampilkan Informasi"):
        dataset = """
        Data yang dianalisis adalah dataset yang bersumber dari Katalog Data Kementerian Pariwisata dan Ekonomi Kreatif Republik Indonesia (Kemenparekraf RI) dengan judul **Jumlah Kunjungan Wisatawan Mancanegara per Bulan per Pintu Masuk 2017-2022**. Link gambaran umum dataset sampai fitur untuk mendownload file data tersebut bisa diakses [di sini](https://katalogdata.kemenparekraf.go.id/dataset/jumlah-kunjungan-wisatawan-mancanegara/resource/23ef4f91-bd2b-4321-bb89-8225d9edb331). 
        """
...
bar_chart = alt.Chart(bar_chart_data).mark_bar().encode(
    ...
    color=alt.Color('nama_pintu_masuk:N', scale=alt.Scale(scheme='category20')),
